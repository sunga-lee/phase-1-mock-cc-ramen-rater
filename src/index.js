...
const detail = document.getElementById("ramen-details");
    ...
    ramens.forEach((ramen)=>{
        ...
        img.addEventListener("click",())=
            ...
            .then((details)=>{
                detail.innerHTML = 
                `<h4>${detail.name}</h4>
                <p>Restaurant:${detail.restaurant}</p>
                <img src="${details.image}" alt="${detail.name}"></>
        ...
        form.addEventListener("submit",(event)=>{
            ...
            newRamenRestaurant.textContent = restaurant.value;
            ...
            newRamenImage.addEventListener("click",()=>{
                detail.innerHTML=`<h4>${newRamenName.textContent}</h4>
